...
A basic timer application taking seconds as input using [ReactJS](https://reactjs.org/).

Check [here](https://sample-react-projects.web.app/react-timer) for live demo.
